...
COLUMNS = [
    ...
    _c("22D High Now",        "52W & Historical High/Low", _YFD, _SC, "computed", "made_high_22d",          "bool",   "True if today's close equals the 22-day closing high"),
    _c("22D Low Now",         "52W & Historical High/Low", _YFD, _SC, "computed", "made_low_22d",           "bool",   "True if today's close equals the 22-day closing low"),
    _c("3Y High Close",       "52W & Historical High/Low", _YFD, _SC, "raw",      "high_close_3y",          "float",  "Highest closing price over trailing 3 years"),
    _c("3Y Low Close",        "52W & Historical High/Low", _YFD, _SC, "raw",      "low_close_3y",           "float",  "Lowest closing price over trailing 3 years"),
    _c("52W High Close",      "52W & Historical High/Low", _YFD, _SC, "raw",      "high_close_52w",         "float",  "Highest closing price over trailing 52 weeks"),
    _c("52W High Now",        "52W & Historical High/Low", _YFD, _SC, "computed", "made_high_252d",         "bool",   "True if today's close equals the 52-week closing high"),
    _c("52W Low Close",       "52W & Historical High/Low", _YFD, _SC, "raw",      "low_close_52w",          "float",  "Lowest closing price over trailing 52 weeks"),
    _c("52W Low Now",         "52W & Historical High/Low", _YFD, _SC, "computed", "made_low_252d",          "bool",   "True if today's close equals the 52-week closing low"),
    _c("5D High Now",         "52W & Historical High/Low", _YFD, _SC, "computed", "made_high_5d",           "bool",   "True if today's close equals the 5-day closing high"),
    _c("5D Low Now",          "52W & Historical High/Low", _YFD, _SC, "computed", "made_low_5d",            "bool",   "True if today's close equals the 5-day closing low"),
    _c("Days Since 52W High", "52W & Historical High/Low", _YFD, _SC, "computed", "days_since_52w_high",    "int",    "Trading days since the 52-week closing high was set"),
    _c("Days Since 52W Low",  "52W & Historical High/Low", _YFD, _SC, "computed", "days_since_52w_low",     "int",    "Trading days since the 52-week closing low was set"),
    _c("From 3Y High Close%", "52W & Historical High/Low", _YFD, _SC, "computed", "pct_from_high_close_3y", "float%", "% below the 3-year closing high"),
    _c("From 3Y Low Close%",  "52W & Historical High/Low", _YFD, _SC, "computed", "pct_from_low_close_3y",  "float%", "% above the 3-year closing low"),
    _c("From 52W High Close%","52W & Historical High/Low", _YFD, _SC, "computed", "pct_from_high_close_52w","float%", "% below the 52-week closing high"),
    _c("From 52W Low Close%", "52W & Historical High/Low", _YFD, _SC, "computed", "pct_from_low_close_52w", "float%", "% above the 52-week closing low"),
